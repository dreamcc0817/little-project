package com.dreamcc.little.project.rocketmq.api.pay.controller;

import com.dreamcc.little.project.rocketmq.api.order.service.OrderService;
import com.dreamcc.little.project.rocketmq.api.pay.constant.PayTransactionStatusConstant;
import com.dreamcc.little.project.rocketmq.api.pay.dto.PayTransaction;
import com.dreamcc.little.project.rocketmq.api.pay.dto.QueryPayStatusResponse;
import com.dreamcc.little.project.rocketmq.api.pay.service.PayTransactionService;
import com.dreamcc.little.project.rocketmq.common.constants.PayTypeConstant;
...
import static com.dreamcc.little.project.rocketmq.common.constants.RedisKeyConstant.ORDER_DUPLICATION_KEY_PREFIX;
...
public class PayController {
    ...
    public CommonResponse<Integer> wxCallback(QueryPayStatusResponse queryPayStatusResponse) {
        ...
        if (Objects.equals(response.getCode(), ErrorCodeEnum.FAIL.getCode())) {
            log.info(" pay order redis dubbo interface error orderNo:{}", orderNo);
        ...
        if (Objects.equals(response.getData(), Boolean.FALSE)) {
            // 重复订单 返回
            log.info("duplicate pay order orderNo:{}", orderNo);
